...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/vending/licensing/Policy;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "background thread"
...
.method private cleanupService()V
    ...
    const-string/jumbo v1, "LicenseChecker"

    const-string/jumbo v2, "Unable to unbind from licensing service (already unbound)"
...
.method private static generatePublicKey(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    const-string/jumbo v3, "LicenseChecker"

    const-string/jumbo v4, "Could not decode from Base64."
...
.method private static getVersionCode(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "Package not found. could not get version code."
...
.method private runChecks()V
    ...
    .line 186
    :try_start_0
    const-string/jumbo v2, "LicenseChecker"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "Calling checkLicense on service for "
    ...
    const-string/jumbo v3, "RemoteException in checkLicense call."
...
.method public declared-synchronized checkAccess(Lcom/google/android/vending/licensing/LicenseCheckerCallback;)V
    ...
    const-string/jumbo v2, "Using cached license response"
    ...
    const-string/jumbo v2, "Binding to licensing service."
    ...
    const-string/jumbo v2, "Y29tLmFuZHJvaWQudmVuZGluZy5saWNlbnNpbmcuSUxpY2Vuc2luZ1NlcnZpY2U="
    ...
    const-string/jumbo v2, "Could not bind to service."
...
.method public declared-synchronized onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    :try_start_0
    const-string/jumbo v0, "LicenseChecker"

    const-string/jumbo v1, "Service unexpectedly disconnected."
