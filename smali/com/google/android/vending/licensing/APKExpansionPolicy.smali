...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/vending/licensing/Obfuscator;)V
    ...
    .line 90
    const-string/jumbo v1, "com.android.vending.licensing.APKExpansionPolicy"
    ...
    const-string/jumbo v2, "lastResponse"
    ...
    const-string/jumbo v2, "validityTimestamp"
    ...
    const-string/jumbo v2, "retryUntil"
    ...
    const-string/jumbo v2, "maxRetries"
...
.method private decodeExtras(Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string/jumbo v7, "APKExpansionPolicy"

    const-string/jumbo v8, "Invalid syntax error while decoding extras data from server."
...
.method private setLastResponse(I)V
    ...
    const-string/jumbo v1, "lastResponse"
...
.method private setMaxRetries(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "APKExpansionPolicy"

    const-string/jumbo v3, "Licence retry count (GR) missing, grace period disabled"
...
.method private setRetryUntil(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "retryUntil"
    ...
    const-string/jumbo v3, "License retry timestamp (GT) missing, grace period disabled"
...
.method private setValidityTimestamp(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "validityTimestamp"
    ...
    const-string/jumbo v3, "License validity timestamp (VT) missing, caching for a minute"
...
.method public processServerResponse(ILcom/google/android/vending/licensing/ResponseData;)V
    ...
    .line 152
    :cond_4
    const-string/jumbo v4, "FILE_URL"
