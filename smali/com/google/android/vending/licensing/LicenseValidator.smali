...
.method public verify(Ljava/security/PublicKey;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 108
    const-string/jumbo v5, "LicenseValidator"

    const-string/jumbo v6, "Signature verification failed."
    ...
    const-string/jumbo v6, "Could not Base64-decode signature."
    ...
    const-string/jumbo v6, "Response codes don\'t match."
    ...
    const-string/jumbo v6, "Could not parse response."
    ...
    const-string/jumbo v6, "Nonce doesn\'t match."
    ...
    const-string/jumbo v6, "Package name doesn\'t match."
    ...
    const-string/jumbo v6, "Version codes don\'t match."
    ...
    const-string/jumbo v6, "User identifier is empty."
    ...
    const-string/jumbo v6, "Unknown response code for license check."
    ...
    const-string/jumbo v6, "Error contacting licensing server."
    ...
    const-string/jumbo v6, "An error has occurred on the licensing server."
    ...
    const-string/jumbo v6, "Licensing server is refusing to talk to this device, over quota."
