...
.method public constructor <init>()V
    ...
    .prologue
    .line 65
    const-string/jumbo v0, "LVLDownloadService"
...
.method private cancelAlarms()V
    ...
    const-string/jumbo v2, "couldn\'t get alarm manager"
...
.method private scheduleAlarm(J)V
    ...
    const-string/jumbo v4, "couldn\'t get alarm manager"
    ...
    const-string/jumbo v3, "android.intent.action.DOWNLOAD_WAKEUP"

    invoke-direct {v2, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 955
    .local v2, "intent":Landroid/content/Intent;
    const-string/jumbo v3, "EPI"
...
.method public generateSaveFile(Ljava/lang/String;J)Ljava/lang/String;
    ...
    .line 1233
    const-string/jumbo v2, "LVLDL"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "External media not mounted: "
    ...
    const-string/jumbo v4, "external media is not yet mounted"
    ...
    const-string/jumbo v4, "insufficient space on external storage"
...
.method public getLogMessageForNetworkError(I)Ljava/lang/String;
    ...
    .line 1257
    :pswitch_0
    const-string/jumbo v0, "download size exceeds recommended limit for mobile network"

    goto :goto_0

    .line 1260
    :pswitch_1
    const-string/jumbo v0, "download size exceeds limit for mobile network"

    goto :goto_0

    .line 1263
    :pswitch_2
    const-string/jumbo v0, "no network connection available"

    goto :goto_0

    .line 1266
    :pswitch_3
    const-string/jumbo v0, "download cannot use the current network connection because it is roaming"

    goto :goto_0

    .line 1269
    :pswitch_4
    const-string/jumbo v0, "download was requested to not use the current network type"
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    const-string/jumbo v1, "Service Bound"
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    :cond_1
    :try_start_2
    const-string/jumbo v16, "LVLDL"

    const-string/jumbo v17, "Downloader started in bad state without notification intent."
    ...
    const-string/jumbo v16, "android.net.conn.CONNECTIVITY_CHANGE"
...
.method pollNetworkState()V
    ...
    const-string/jumbo v2, "couldn\'t get connectivity manager to poll network state"
