...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "REDIRECTCOUNT"

    aput-object v2, v0, v1

    const/16 v1, 0xb

    const-string/jumbo v2, "FILEIDX"
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "SELECT APKVERSION,_id,DOWNLOADSTATUS,DOWNLOADFLAGS FROM MetadataColumns LIMIT 1"
...
.method private getDownloadByIndexStatement()Landroid/database/sqlite/SQLiteStatement;
    ...
    const-string/jumbo v1, "SELECT _id FROM DownloadColumns WHERE FILEIDX = ?"
...
.method private getUpdateCurrentBytesStatement()Landroid/database/sqlite/SQLiteStatement;
    ...
    const-string/jumbo v1, "UPDATE DownloadColumns SET CURRENTBYTES = ? WHERE FILEIDX = ?"
...
.method protected getDownloadInfoByFileName(Ljava/lang/String;)Lcom/google/android/vending/expansion/downloader/impl/DownloadInfo;
    ...
    :try_start_0
    const-string/jumbo v1, "DownloadColumns"
...
.method public isDownloadRequired()Z
    ...
    .line 368
    .local v1, "sqldb":Landroid/database/sqlite/SQLiteDatabase;
    const-string/jumbo v4, "SELECT Count(*) FROM DownloadColumns WHERE STATUS <> 0"
...
.method public updateDownload(Lcom/google/android/vending/expansion/downloader/impl/DownloadInfo;)Z
    ...
    .line 333
    const-string/jumbo v1, "CURRENTBYTES"
    ...
    .line 339
    const-string/jumbo v1, "REDIRECTCOUNT"
...
.method public updateDownload(Lcom/google/android/vending/expansion/downloader/impl/DownloadInfo;Landroid/content/ContentValues;)Z
    ...
    .line 348
    const-string/jumbo v4, "DownloadColumns"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "DownloadColumns._id = "
    ...
    :cond_2
    :try_start_1
    const-string/jumbo v8, "DownloadColumns"
...
.method public updateFlags(I)Z
    ...
    .line 389
    .local v0, "cv":Landroid/content/ContentValues;
    const-string/jumbo v2, "DOWNLOADFLAGS"
...
.method public updateMetadata(Landroid/content/ContentValues;)Z
    ...
    .line 419
    const-string/jumbo v4, "MetadataColumns"
...
.method public updateStatus(I)Z
    ...
    .line 404
    .local v0, "cv":Landroid/content/ContentValues;
    const-string/jumbo v2, "DOWNLOADSTATUS"
