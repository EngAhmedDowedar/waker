...
.field h:Lcom/vungle/publisher/cp;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field q:Lcom/vungle/publisher/db/model/LoggedException$Factory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method final a(Z)Lcom/vungle/publisher/db/model/LocalAd;
    ...
    .line 140
    .line 142
    iget-object v1, p0, Lcom/vungle/publisher/ad/AdManager;->c:Lcom/vungle/publisher/bt;
    ...
    const-string/jumbo v2, "no local ad available"
    ...
    new-instance v2, Lcom/vungle/publisher/cw;

    invoke-direct {v2}, Lcom/vungle/publisher/cw;-><init>()V

    invoke-virtual {v1, v2}, Lcom/vungle/publisher/protocol/ProtocolHttpGateway;->a(Lcom/vungle/publisher/cw;)V
    ...
    const-string/jumbo v4, "local ad partially prepared, restarting preparation for "
    ...
    const-string/jumbo v4, "local ad partially prepared, but not restarting preparation for "
    ...
    const-string/jumbo v3, "local ad already available for "
    ...
    const-string/jumbo v2, "unable to fetch local ad -  no external storage available"
...
.method final a(Ljava/lang/String;Lcom/vungle/publisher/c;)Lcom/vungle/publisher/db/model/StreamingAd;
    ...
    iget-object v0, p0, Lcom/vungle/publisher/ad/AdManager;->h:Lcom/vungle/publisher/cp;

    invoke-interface {v0}, Lcom/vungle/publisher/cp;->a()Lcom/vungle/publisher/co;
    ...
    const-string/jumbo v2, "ad streaming "
    ...
    const-string/jumbo v2, "requesting streaming ad"
    ...
    const-string/jumbo v5, "VungleConfig"

    new-instance v6, Ljava/lang/StringBuilder;

    const-string/jumbo v7, "streaming response timeout config "
    ...
    const-string/jumbo v3, "ad streaming disabled"
    ...
    .line 265
    :goto_3
    iget-object v2, p0, Lcom/vungle/publisher/ad/AdManager;->q:Lcom/vungle/publisher/db/model/LoggedException$Factory;

    const-string/jumbo v3, "VunglePrepare"

    const-string/jumbo v4, "error getting streaming ad"
    ...
    const-string/jumbo v6, "request streaming ad success after "
    ...
    const-string/jumbo v6, "request streaming ad timeout after "
