...
.field e:Lcom/vungle/publisher/ad/prepare/PrepareViewableRunnable$Factory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field

.field f:Lcom/vungle/publisher/ad/prepare/PrepareAdRunnable$RetryMap;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field

.field g:Lcom/vungle/publisher/db/model/LoggedException$Factory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method private a()Lcom/vungle/publisher/db/model/LocalAd;
    ...
    new-instance v3, Lcom/vungle/publisher/u;

    invoke-direct {v3}, Lcom/vungle/publisher/u;-><init>()V
    ...
    const-string/jumbo v3, "ad status: "
    ...
    .line 101
    :pswitch_1
    const-string/jumbo v2, "VunglePrepare"

    new-instance v3, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "ad already "
    ...
    const-string/jumbo v4, "VunglePrepare"

    new-instance v5, Ljava/lang/StringBuilder;

    const-string/jumbo v6, "error saving ad "
    ...
    const-string/jumbo v5, " to database"
...
.method private a(Lcom/vungle/publisher/db/model/LocalAd;)Lcom/vungle/publisher/db/model/LocalAd;
    ...
    const-string/jumbo v3, "VunglePrepare"

    new-instance v4, Ljava/lang/StringBuilder;

    const-string/jumbo v5, "clock change detected; updating ad.id "
    ...
    const-string/jumbo v4, " status from "
    ...
    .line 128
    :goto_1
    iget v0, p1, Lcom/vungle/publisher/db/model/LocalAd;->z:I
    ...
    const-string/jumbo v3, "unexpected ad.status: "
    ...
    const-string/jumbo v3, " for ad.id: "
    ...
    const-string/jumbo v4, "/1440 minutes; updating status from "
    ...
    const-string/jumbo v2, "ad marked failed "
    ...
    const-string/jumbo v2, " minutes ago"
    ...
    const-string/jumbo v4, "prepare_retry_count "
    ...
    const-string/jumbo v3, "failed to prepare ad after "
...
.method private b(Lcom/vungle/publisher/db/model/LocalAd;)V
    ...
    .line 195
    invoke-virtual {p1}, Lcom/vungle/publisher/db/model/LocalAd;->B()[Lcom/vungle/publisher/bk;
    ...
    const-string/jumbo v8, "VunglePrepare"
    ...
    const-string/jumbo v10, " has status "
    ...
    sget-object v8, Lcom/vungle/publisher/bj$a;->a:Lcom/vungle/publisher/bj$a;

    if-eq v7, v8, :cond_0

    sget-object v8, Lcom/vungle/publisher/bj$a;->f:Lcom/vungle/publisher/bj$a;

    if-ne v7, v8, :cond_1

    :cond_0
    sget-object v8, Lcom/vungle/publisher/bj$a;->b:Lcom/vungle/publisher/bj$a;

    invoke-interface {v2, v8}, Lcom/vungle/publisher/bk;->b(Lcom/vungle/publisher/bj$a;)V
    ...
    invoke-virtual {v9, v8}, Lcom/vungle/publisher/ad/prepare/PrepareAdRunnable$RetryMap;->a(Ljava/lang/String;)Lcom/vungle/publisher/cw;

    move-result-object v8

    const-string/jumbo v9, "VunglePrepare"

    new-instance v10, Ljava/lang/StringBuilder;

    const-string/jumbo v11, "begin preparing "
    ...
    invoke-virtual {v10, v2, v8}, Lcom/vungle/publisher/ad/prepare/PrepareViewableRunnable$Factory;->a(Lcom/vungle/publisher/bk;Lcom/vungle/publisher/cw;)Lcom/vungle/publisher/ad/prepare/PrepareViewableRunnable;
    ...
    :cond_1
    sget-object v2, Lcom/vungle/publisher/bj$a;->e:Lcom/vungle/publisher/bj$a;
    ...
    .line 201
    const-string/jumbo v0, "VunglePrepare"

    new-instance v1, Ljava/lang/StringBuilder;

    const-string/jumbo v2, "ad ready "
    ...
    const-string/jumbo v2, "ad not ready "
...
.method private c(Lcom/vungle/publisher/db/model/LocalAd;)V
    ...
    const-string/jumbo v3, "re-verify prepare_retry_count "

    invoke-direct {v2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v3, p1, Lcom/vungle/publisher/db/model/LocalAd;->z:I
    ...
    .line 216
    invoke-interface {v4}, Lcom/vungle/publisher/bk;->t()Z
    ...
    const-string/jumbo v2, " re-verification failed for ad_id "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-interface {v4}, Lcom/vungle/publisher/bk;->d()Ljava/lang/String;
    ...
    const-string/jumbo v4, "re-verified ad and set to "
...
.method private static d(Lcom/vungle/publisher/db/model/LocalAd;)V
    ...
    const-string/jumbo v5, "VunglePrepare"
    ...
    sget-object v9, Lcom/vungle/publisher/bj$b;->c:Lcom/vungle/publisher/bj$b;
    ...
    sget-object v6, Lcom/vungle/publisher/bj$b;->a:Lcom/vungle/publisher/bj$b;
    ...
    sget-object v3, Lcom/vungle/publisher/bj$b;->b:Lcom/vungle/publisher/bj$b;
    ...
    const-string/jumbo v1, "invalid ad - no viewables"
...
.method public run()V
    ...
    const-string/jumbo v3, "run PrepareAdRunnable. adId = "
    ...
    new-instance v4, Lcom/vungle/publisher/cw;

    invoke-direct {v4}, Lcom/vungle/publisher/cw;-><init>()V
    ...
    invoke-direct {v3}, Lcom/vungle/publisher/ai;-><init>()V
    ...
    const-string/jumbo v4, " for ad.id "
    ...
    invoke-virtual {v2, v4}, Lcom/vungle/publisher/ad/prepare/PrepareAdRunnable$RetryMap;->a(Ljava/lang/String;)Lcom/vungle/publisher/cw;
    ...
    new-instance v3, Lcom/vungle/publisher/w;
    ...
    invoke-direct {v3, v2}, Lcom/vungle/publisher/w;-><init>(Lcom/vungle/publisher/cw;)V
    ...
    const-string/jumbo v6, "error processing ad.id: "
