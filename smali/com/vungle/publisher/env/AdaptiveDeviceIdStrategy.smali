...
.method protected final b(Lcom/vungle/publisher/env/AndroidDevice;)Z
    ...
    const-string/jumbo v2, "have advertising ID - not fetching fallback device IDs"
    ...
    const-string/jumbo v1, "ensuring fallback device IDs"
    ...
    const-string/jumbo v3, "fetched android ID "
    ...
    const-string/jumbo v1, "have advertising id - not setting androidId"
    ...
    const-string/jumbo v1, "unable to get MAC address - not connected"
    ...
    const-string/jumbo v3, "setting android ID "
    ...
    const-string/jumbo v2, "existing android ID "
    ...
    const-string/jumbo v3, "fetched MAC address "
    ...
    const-string/jumbo v1, "have advertising id - not setting mac address"
    ...
    const-string/jumbo v1, "unable to get MAC address - no ACCESS_WIFI_STATE permission"
    ...
    const-string/jumbo v3, "setting MAC address "
    ...
    const-string/jumbo v3, "existing MAC address "
