.class public abstract Lcom/vungle/publisher/ct;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 27
    const-string/jumbo v0, "\\bcharset=([\\w\\-]+)\\b"

    invoke-static {v0}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v0

    sput-object v0, Lcom/vungle/publisher/ct;->a:Ljava/util/regex/Pattern;
...
.method public final a(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/vungle/publisher/ct;->a:Ljava/util/regex/Pattern;
    ...
    const-string/jumbo v7, "response character set: "
    ...
    .line 133
    iget-object v2, p0, Lcom/vungle/publisher/ct;->g:Lcom/vungle/publisher/db/model/LoggedException$Factory;
...
.method public a(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;Ljava/lang/Exception;)V
    ...
    .prologue
    .line 70
    iget-object v0, p0, Lcom/vungle/publisher/ct;->g:Lcom/vungle/publisher/db/model/LoggedException$Factory;

    const-string/jumbo v1, "VungleNetwork"

    new-instance v2, Ljava/lang/StringBuilder;

    const-string/jumbo v3, "error while handling response: "
    ...
    .line 71
    invoke-virtual {p0, p1, p2}, Lcom/vungle/publisher/ct;->b(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
...
.method public b(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    const-string/jumbo v2, " failed permanently with response code "
...
.method public c(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    invoke-static {v0}, Lcom/vungle/publisher/ct;->a(I)Z
    :try_end_0
    ...
    .line 40
    :try_start_1
    invoke-virtual {p0, p1, p2}, Lcom/vungle/publisher/ct;->a(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    :try_end_1
    ...
    :cond_0
    :goto_1
    invoke-virtual {p0, p1, p2}, Lcom/vungle/publisher/ct;->d(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    :try_end_2
    ...
    .line 59
    invoke-virtual {p0, p1, p2, v0}, Lcom/vungle/publisher/ct;->a(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;Ljava/lang/Exception;)V
    ...
    .line 48
    :try_start_3
    iget-object v1, p0, Lcom/vungle/publisher/ct;->g:Lcom/vungle/publisher/db/model/LoggedException$Factory;

    const-string/jumbo v2, "VungleNetwork"

    new-instance v3, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "IOException while handling response: "
    ...
    const-string/jumbo v4, "JSONException while handling response: "
