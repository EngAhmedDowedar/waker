...
.field c:Lcom/vungle/publisher/bj$b;
...
.field e:Lcom/vungle/publisher/ad/AdManager;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method protected final a(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    .line 63
    invoke-static {v5}, Lcom/vungle/publisher/cc;->b(Ljava/io/File;)Z
    ...
    const-string/jumbo v7, "downloading to: "
    ...
    const-string/jumbo v5, "download complete: "
    ...
    .line 78
    iget-object v4, p0, Lcom/vungle/publisher/net/http/DownloadHttpResponseHandler;->c:Lcom/vungle/publisher/bj$b;

    invoke-virtual {v3, v4}, Lcom/vungle/publisher/db/model/LocalAd;->b(Lcom/vungle/publisher/bj$b;)Lcom/vungle/publisher/bk;
    ...
    iget-object v5, p0, Lcom/vungle/publisher/net/http/DownloadHttpResponseHandler;->c:Lcom/vungle/publisher/bj$b;

    invoke-virtual {v5}, Lcom/vungle/publisher/bj$b;->ordinal()I
    ...
    :goto_4
    const-string/jumbo v1, "VungleNetwork"
    ...
    const-string/jumbo v5, " downloaded for ad "
    ...
    invoke-interface {v3, v1}, Lcom/vungle/publisher/bk;->a(Lcom/vungle/publisher/bj$a;)V

    invoke-interface {v3}, Lcom/vungle/publisher/bk;->m()I

    .line 80
    iget-object v1, p0, Lcom/vungle/publisher/net/http/DownloadHttpResponseHandler;->d:Lcom/vungle/publisher/event/EventBus;

    new-instance v4, Lcom/vungle/publisher/n;

    iget-object v5, p1, Lcom/vungle/publisher/net/http/HttpTransaction;->b:Lcom/vungle/publisher/cw;

    invoke-direct {v4, v3, v5}, Lcom/vungle/publisher/n;-><init>(Lcom/vungle/publisher/bk;Lcom/vungle/publisher/cw;)V
    ...
    invoke-interface {v3, v1}, Lcom/vungle/publisher/bk;->a(Ljava/lang/Integer;)V
    ...
    const-string/jumbo v6, "download size mismatch: "
    ...
    const-string/jumbo v6, ", expected size: "
    ...
    const-string/jumbo v4, "could not create or directory not writeable: "
    ...
    const-string/jumbo v3, ": error closing output stream"
    ...
    const-string/jumbo v4, ": error closing output stream"
...
.method protected final b(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    new-instance v1, Lcom/vungle/publisher/m;

    iget-object v2, p1, Lcom/vungle/publisher/net/http/HttpTransaction;->b:Lcom/vungle/publisher/cw;

    invoke-direct {v1, v2}, Lcom/vungle/publisher/m;-><init>(Lcom/vungle/publisher/cw;)V
