...
# instance fields
.field a:Lcom/vungle/publisher/net/http/HttpURLConnectionFactory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field

.field b:Lcom/vungle/publisher/net/http/HttpResponse$Factory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field

.field c:Lcom/vungle/publisher/net/http/HttpRequestChainElement$Factory;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method private static a(Lcom/vungle/publisher/net/http/HttpRequest$a;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 170
    const-string/jumbo v2, " redirect count "
    ...
    .line 186
    :cond_1
    const-string/jumbo v2, " requested URL "
    ...
    .line 189
    const-string/jumbo v1, ", next URL "
...
.method private static a(Ljava/net/HttpURLConnection;Lcom/vungle/publisher/net/http/HttpRequest;)V
    ...
    .line 140
    const-string/jumbo v7, "VungleNetwork"

    new-instance v8, Ljava/lang/StringBuilder;

    const-string/jumbo v9, "request header: "
    ...
    .line 146
    :cond_1
    const-string/jumbo v4, "VungleNetwork"
...
.method public final a(Lcom/vungle/publisher/net/http/HttpRequest;)Lcom/vungle/publisher/net/http/HttpResponse;
    ...
    .line 60
    :try_start_1
    const-string/jumbo v2, "VungleNetwork"
    ...
    const-string/jumbo v3, "VungleNetwork"

    new-instance v4, Ljava/lang/StringBuilder;

    const-string/jumbo v6, "request body: "
    ...
    const-string/jumbo v9, "gzipped request from "
    ...
    const-string/jumbo v6, " bytes down to "
    ...
    .line 69
    const-string/jumbo v9, "VungleNetwork"
    ...
    invoke-static {v3, v5}, Lcom/vungle/publisher/net/http/HttpRequestChainElement;->a(Lcom/vungle/publisher/net/http/HttpRequestChainElement;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v3, v2}, Lcom/vungle/publisher/net/http/HttpRequestChainElement;->a(Lcom/vungle/publisher/net/http/HttpRequestChainElement;I)I

    invoke-static {v3, v6}, Lcom/vungle/publisher/net/http/HttpRequestChainElement;->b(Lcom/vungle/publisher/net/http/HttpRequestChainElement;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v3, v4}, Lcom/vungle/publisher/net/http/HttpRequestChainElement;->a(Lcom/vungle/publisher/net/http/HttpRequestChainElement;Ljava/lang/Long;)Ljava/lang/Long;
    ...
    invoke-static {v0, v1}, Lcom/vungle/publisher/net/http/HttpResponse;->a(Lcom/vungle/publisher/net/http/HttpResponse;Ljava/net/HttpURLConnection;)Ljava/net/HttpURLConnection;

    invoke-static {v0, v8}, Lcom/vungle/publisher/net/http/HttpResponse;->a(Lcom/vungle/publisher/net/http/HttpResponse;Ljava/util/List;)Ljava/util/List;

    invoke-static {v0, v2}, Lcom/vungle/publisher/net/http/HttpResponse;->a(Lcom/vungle/publisher/net/http/HttpResponse;I)I
    ...
    :goto_5
    invoke-static {v0, v1}, Lcom/vungle/publisher/net/http/HttpResponse;->a(Lcom/vungle/publisher/net/http/HttpResponse;Ljava/lang/String;)Ljava/lang/String;
