...
.super Lcom/vungle/publisher/ct;
.source "vungle"
...
.method public constructor <init>()V
    ...
    .prologue
    .line 61
    invoke-direct {p0}, Lcom/vungle/publisher/ct;-><init>()V
...
.method protected final d(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    .line 85
    iget-object v4, p1, Lcom/vungle/publisher/net/http/HttpTransaction;->b:Lcom/vungle/publisher/cw;

    .line 86
    iget v5, v4, Lcom/vungle/publisher/cw;->b:I
    ...
    iget-wide v6, v4, Lcom/vungle/publisher/cw;->a:J
    ...
    .line 94
    iget v0, v4, Lcom/vungle/publisher/cw;->c:I
    ...
    iput v0, v4, Lcom/vungle/publisher/cw;->c:I

    if-gez v0, :cond_0

    const-string/jumbo v0, "VungleNetwork"

    const-string/jumbo v3, "Attempted to decrement softRetryCount < 0"

    invoke-static {v0, v3}, Lcom/vungle/log/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V

    iput v2, v4, Lcom/vungle/publisher/cw;->c:I
    ...
    invoke-static {v5, v0, v1}, Lcom/vungle/publisher/de;->a(III)I
    ...
    const-string/jumbo v3, "Retrying "
    ...
    new-instance v2, Lcom/vungle/publisher/cv;

    invoke-direct {v2, p1}, Lcom/vungle/publisher/cv;-><init>(Lcom/vungle/publisher/net/http/HttpTransaction;)V
    ...
    .line 114
    :cond_7
    invoke-super {p0, p1, p2}, Lcom/vungle/publisher/ct;->d(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
