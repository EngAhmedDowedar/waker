.class public Lcom/vungle/publisher/cy;
...
.field public c:Lcom/vungle/publisher/event/EventBus;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method protected final a(Lcom/vungle/publisher/net/http/HttpTransaction;Lcom/vungle/publisher/net/http/HttpResponse;)V
    ...
    .prologue
    .line 37
    iget-object v0, p0, Lcom/vungle/publisher/cy;->a:Lcom/vungle/publisher/protocol/message/RequestConfigResponse$Factory;

    iget-object v1, p2, Lcom/vungle/publisher/net/http/HttpResponse;->a:Ljava/net/HttpURLConnection;

    invoke-virtual {p0, v1}, Lcom/vungle/publisher/cy;->a(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    .line 43
    iget-object v1, p0, Lcom/vungle/publisher/cy;->d:Ljavax/inject/Provider;
    ...
    .line 47
    sget-object v2, Lcom/vungle/publisher/cy$1;->a:[I
    ...
    const-string/jumbo v4, "unhandled streaming connectivity type "
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lcom/vungle/publisher/cy;->b:Lcom/vungle/publisher/env/SdkConfig;
    ...
    const-string/jumbo v4, "VungleConfig"
    ...
    const-string/jumbo v5, " ad streaming"
    ...
    .line 59
    iget-object v1, p0, Lcom/vungle/publisher/cy;->b:Lcom/vungle/publisher/env/SdkConfig;
    ...
    const-string/jumbo v3, "VungleConfig"

    new-instance v4, Ljava/lang/StringBuilder;

    const-string/jumbo v5, "setting exception reporting enabled: "
    ...
    const-string/jumbo v2, "null request streaming ad timeout millis"
    ...
    const-string/jumbo v0, "VungleConfig"

    new-instance v3, Ljava/lang/StringBuilder;

    const-string/jumbo v6, "setting app fingerprint frequency to "
    ...
    .line 74
    iget-object v0, p0, Lcom/vungle/publisher/cy;->b:Lcom/vungle/publisher/env/SdkConfig;
    ...
    .line 77
    :cond_3
    iget-object v0, p0, Lcom/vungle/publisher/cy;->c:Lcom/vungle/publisher/event/EventBus;

    new-instance v1, Lcom/vungle/publisher/cq;

    invoke-direct {v1}, Lcom/vungle/publisher/cq;-><init>()V
    ...
    invoke-static {}, Lcom/vungle/publisher/co;->values()[Lcom/vungle/publisher/co;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/vungle/publisher/env/SdkConfig;->a([Lcom/vungle/publisher/co;)V
    ...
    new-array v2, v2, [Lcom/vungle/publisher/co;

    const/4 v3, 0x0

    sget-object v4, Lcom/vungle/publisher/co;->b:Lcom/vungle/publisher/co;
    ...
    const-string/jumbo v5, "setting streaming response timeout "
