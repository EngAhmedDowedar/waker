.class Lcom/vungle/publisher/protocol/EventTrackingHttpLogEntryDeleteDelegate;
...
# instance fields
.field a:Lcom/vungle/publisher/db/model/EventTrackingHttpLogEntry$Factory;
...
.method final a(Ljava/util/List;)I
    ...
    const-string/jumbo v1, "no event tracking HTTP log entries to delete"
    ...
    const-string/jumbo v2, " event tracking HTTP log entries"
