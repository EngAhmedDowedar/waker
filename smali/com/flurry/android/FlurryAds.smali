...
.method constructor <init>()V
    ...
    const-string/jumbo v2, "directOpen"
    ...
    const-string/jumbo v2, "doExpand"
    ...
    const-string/jumbo v2, "doCollapse"
    ...
    const-string/jumbo v2, "closeAd"

    aput-object v2, v1, v6

    const-string/jumbo v2, "expandAd"

    aput-object v2, v1, v7

    const/4 v2, 0x4

    const-string/jumbo v3, "collapseAd"
    ...
    const-string/jumbo v1, "FlurryAdThread"
...
.method private declared-synchronized a(Lcom/flurry/android/cw;Ljava/lang/String;ZLjava/util/Map;)Lcom/flurry/android/cw;
    ...
    const-string/jumbo v1, "changeAdState("
    ...
    const-string/jumbo v1, "changeAdState added adLog = "
...
.method private a(Landroid/content/Context;Lcom/flurry/android/AdUnit;)Lcom/flurry/android/fm;
    ...
    const-string/jumbo v2, "Failed to create view for ad network: "
    ...
    const-string/jumbo v2, ", network is unsupported on Android, or no ICustomAdNetworkHandler was registered or it failed to return a view."
    ...
    const-string/jumbo v1, "renderFailed"
...
.method private static a([BLjava/lang/Class;)Lcom/flurry/org/apache/avro/specific/SpecificRecordBase;
    ...
    const-string/jumbo v3, "ClassCastException in parseAvroBinary:"
    ...
    const-string/jumbo v2, "ClassCastException in parseAvroBinary: bytes = "
    ...
    const-string/jumbo v3, "IOException in parseAvroBinary:"
    ...
    const-string/jumbo v2, "IOException in parseAvroBinary: bytes = "
...
.method private static a(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v0, "adSpaceName"
...
.method private static a(Lcom/flurry/android/AdFrame;Lcom/flurry/android/gt;)Ljava/util/List;
    ...
    .line 2612
    const-string/jumbo v7, "%{eventParams}"
...
.method private declared-synchronized a(Lcom/flurry/android/ca;Ljava/io/DataOutputStream;)V
    ...
    const-string/jumbo v4, "unable to convert freqCap to byte[]: "
...
.method private a([BLjava/lang/String;)Z
    ...
    .line 2146
    :cond_0
    const-string/jumbo v0, "/v6/getAds.do"
    ...
    .line 2161
    :try_start_0
    const-string/jumbo v1, "/postAdLog.do"
    ...
    const-string/jumbo v0, "https://ads.flurry.com"

    goto :goto_1

    :cond_3
    const-string/jumbo v0, "http://ads.flurry.com"
    ...
    const-string/jumbo v0, "https://adlog.flurry.com"

    goto :goto_4

    :cond_6
    const-string/jumbo v0, "http://adlog.flurry.com"
...
.method private a(Ljava/lang/String;IIIIZLcom/flurry/android/FlurryAdSize;Landroid/content/Context;)[B
    ...
    const-string/jumbo v4, "Got ad request: "
...
.method private b([BLjava/lang/String;)[B
    ...
    .line 2184
    const-string/jumbo v0, "avro/binary"
    ...
    .line 2190
    const-string/jumbo v2, "Device-UA"
    ...
    const-string/jumbo v3, "Request successful"
    ...
    .line 2210
    const-string/jumbo v3, "FM-Checksum"
    ...
    const-string/jumbo v2, "Request to url = "
    ...
    const-string/jumbo v2, " failed with HTTP = "
    ...
    const-string/jumbo v4, "Request to url = "
    ...
    const-string/jumbo v4, " failed with IOException = "
...
.method private bm()[B
    ...
    const-string/jumbo v3, "Got ad log request:"
    ...
    const-string/jumbo v3, "Error generating adlog request"
...
.method private c([B)V
    ...
    const-string/jumbo v2, "Got ad log response: "
...
.method public static displayAd(Landroid/content/Context;Ljava/lang/String;Landroid/view/ViewGroup;)V
    ...
    const-string/jumbo v1, "Context passed to displayAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to displayAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to displayAd was empty."
    ...
    const-string/jumbo v1, "ViewGroup  passed to displayAd was null."
...
.method public static fetchAd(Landroid/content/Context;Ljava/lang/String;Landroid/view/ViewGroup;Lcom/flurry/android/FlurryAdSize;)V
    ...
    const-string/jumbo v1, "Context passed to fetchAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to fetchAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to fetchAd was empty."
    ...
    const-string/jumbo v1, "ViewGroup passed to fetchAd was null."
    ...
    const-string/jumbo v1, "FlurryAdSize passed to fetchAd was null."
...
.method public static getAd(Landroid/content/Context;Ljava/lang/String;Landroid/view/ViewGroup;Lcom/flurry/android/FlurryAdSize;J)Z
    ...
    const-string/jumbo v2, "Context passed to getAd was null."
    ...
    const-string/jumbo v2, "Ad space name passed to getAd was null."
    ...
    const-string/jumbo v2, "Ad space name passed to getAd was empty."
    ...
    const-string/jumbo v2, "ViewGroup passed to getAd was null."
    ...
    const-string/jumbo v2, "FlurryAdSize passed to getAd was null."
...
.method static i(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "URL hit succeeded for: "
...
.method public static initializeAds(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "Context passed to initializeAds was null."
...
.method public static isAdAvailable(Landroid/content/Context;Ljava/lang/String;Lcom/flurry/android/FlurryAdSize;J)Z
    ...
    const-string/jumbo v1, "Context passed to isAdAvailable was null."
    ...
    const-string/jumbo v1, "Ad space name passed to isAdAvailable was null."
    ...
    const-string/jumbo v1, "Ad space name passed to isAdAvailable was empty."
    ...
    const-string/jumbo v1, "FlurryAdSize passed to isAdAvailable was null."
...
.method public static isAdReady(Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "Ad space name passed to isAdReady was null."
    ...
    const-string/jumbo v2, "Ad space name passed to isAdReady was empty."
...
.method private declared-synchronized m(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, ".flurryadlog."
    ...
    const-string/jumbo v1, ".flurryfreqcap."
    ...
    const-string/jumbo v1, "Attempting to load FreqCap data"
...
.method private static o(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "No connectivity found."
...
.method private declared-synchronized p(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "Initializing ads -- requesting ads with precaching enabled on the server"
    ...
    const-string/jumbo v1, "Initializing ads -- not making a new ad request (for ads with precaching enabled on the server) since one was made already this session"
...
.method public static removeAd(Landroid/content/Context;Ljava/lang/String;Landroid/view/ViewGroup;)V
    ...
    const-string/jumbo v1, "Context passed to removeAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to removeAd was null."
    ...
    const-string/jumbo v1, "Ad space name passed to removeAd was empty."
    ...
    const-string/jumbo v1, "ViewGroup passed to removeAd was null."
    ...
    const-string/jumbo v2, "_removeAd(context = "
    ...
    const-string/jumbo v2, ", adSpaceName = "
...
.method public static setCustomAdNetworkHandler(Lcom/flurry/android/ICustomAdNetworkHandler;)V
    ...
    const-string/jumbo v1, "ICustomAdNetworkHandler passed to setCustomAdNetworkHandler was null."
...
.method public static setTargetingKeywords(Ljava/util/Map;)V
    ...
    const-string/jumbo v1, "targetingKeywords Map passed to setTargetingKeywords was null."
...
.method public static setUserCookies(Ljava/util/Map;)V
    ...
    const-string/jumbo v1, "userCookies Map passed to setUserCookies was null."
    ...
    const-string/jumbo v3, "User cookie keys and values may not be null."
...
.method final a(Landroid/content/Context;Ljava/lang/String;Landroid/view/ViewGroup;ZLcom/flurry/android/FlurryAdSize;)Ljava/util/List;
    ...
    const-string/jumbo v2, "/v6/getAds.do"
    ...
    const-string/jumbo v0, "https://ads.flurry.com/v6/getAds.do"

    goto :goto_2

    :cond_7
    const-string/jumbo v0, "http://ads.flurry.com/v6/getAds.do"
    ...
    const-string/jumbo v2, "Got ad response: "
    ...
    const-string/jumbo v2, "Ad server responded with the following error(s):"
    ...
    const-string/jumbo v1, "Ad server responded but sent no ad units."
...
.method final bk()Ljava/util/Map;
    ...
    .line 1627
    const-string/jumbo v2, "appCloudUserId"
    ...
    const-string/jumbo v2, "flurry_last_user_id"
...
.method final d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Cannot launch Google Play url "
    ...
    const-string/jumbo v2, "https://market.android.com/details?id="
    ...
    const-string/jumbo v2, "Unexpected Google Play url scheme: "
...
.method final g(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "unfilled"
...
.method final h(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "Redirect URL found for: "
    ...
    const-string/jumbo v6, "NumRedirects: "
    ...
    const-string/jumbo v2, "Bad Response status code: "
...
.method public onEvent(Lcom/flurry/android/gt;Lcom/flurry/android/au;I)V
    ...
    const-string/jumbo v1, "adWillClose"
    ...
    const-string/jumbo v1, "videoCompleted"
    ...
    const-string/jumbo v3, "logEvent"
    ...
    const-string/jumbo v1, "__sendToServer"
    ...
    const-string/jumbo v1, "loadAdComponents"
...
.method public performAction$3deb3ec3(Lcom/flurry/android/y;Lcom/flurry/android/FlurryAds;I)V
    ...
    const-string/jumbo v3, "performAction:action="
    ...
    const-string/jumbo v3, ",triggering event="
    ...
    const-string/jumbo v4, "Maximum depth for event/action loop exceeded when performing action:"
    ...
    const-string/jumbo v3, ",triggered by:"
    ...
    .line 2742
    :cond_1
    const-string/jumbo v3, "directOpen"
    ...
    const-string/jumbo v6, "Can\'t start FlurryFullscreenTakeoverActivity, was it declared in the manifest? Falling back to default browser"
    ...
    const-string/jumbo v4, "failed to perform directOpen action: no url in "
    ...
    const-string/jumbo v7, "caught NumberFormatException with count parameter in deleteAds:"
    ...
    .line 2804
    :cond_8
    const-string/jumbo v3, "processRedirect"
    ...
    const-string/jumbo v9, "urlVerified"
    ...
    :cond_d
    const-string/jumbo v9, "urlNotVerified"
    ...
    const-string/jumbo v5, "https://play.google.com/store/apps/details?id="
    ...
    .line 2844
    :cond_10
    const-string/jumbo v3, "sendUrlAsync"
    ...
    const-string/jumbo v5, "url after is: "
    ...
    .line 2851
    :cond_11
    const-string/jumbo v3, "sendAdLogs"
    ...
    const-string/jumbo v3, "__sendToServer"
    ...
    const-string/jumbo v4, "__sendToServer"
    ...
    .line 2862
    :cond_14
    const-string/jumbo v3, "nextFrame"
    ...
    .line 2866
    const-string/jumbo v3, "nextAdUnit"
    ...
    const-string/jumbo v3, "caught NumberFormatException with delay parameter in nextAdUnit:"
    ...
    .line 2903
    :cond_19
    const-string/jumbo v3, "checkCap"
    ...
    .line 2912
    const-string/jumbo v9, "capNotExhausted"
    ...
    const-string/jumbo v6, "Discarding expired frequency cap info for idHash="
    ...
    const-string/jumbo v6, "Frequency cap exhausted for idHash="
    ...
    .line 2923
    const-string/jumbo v9, "capExhausted"
    ...
    .line 2932
    :cond_1c
    const-string/jumbo v3, "updateViewCount"
    ...
    const-string/jumbo v5, "updateViewCount:idHash="
    ...
    const-string/jumbo v4, "FlurryAdAction: !! rendering a capped object: "
...
.method public declared-synchronized savePersistentAdLogData()V
    ...
    const-string/jumbo v3, "Error when saving ad log data: "
