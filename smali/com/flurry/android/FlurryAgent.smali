...
.method private declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "onStartSession called with different api keys: "
    ...
    const-string/jumbo v1, "onStartSession called with duplicate context, use a specific Activity or Service as context instead of using a global context"
    ...
    const-string/jumbo v1, "Initializing Flurry session"
    ...
    const-string/jumbo v3, "onStartSession called from different application packages: "
    ...
    .line 1055
    const-string/jumbo v2, "FlurryAgent"
    ...
    const-string/jumbo v5, "Launch options Key: "
    ...
    const-string/jumbo v4, ". Its value: "
    ...
    const-string/jumbo v1, "Continuing previous session"
...
.method private declared-synchronized a(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v1, "onEndSession called without context from corresponding onStartSession"
    ...
    const-string/jumbo v1, "Ending session"
    ...
    const-string/jumbo v4, "onEndSession called from different application package, expected: "
    ...
    const-string/jumbo v2, "Not creating report because of bad Android ID or generated ID is null"
...
.method private declared-synchronized a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v2, "onError called before onStartSession.  Error: "
...
.method private declared-synchronized a(Ljava/lang/String;Ljava/util/Map;Z)V
    ...
    const-string/jumbo v2, "onEvent called before onStartSession.  Event: "
...
.method private declared-synchronized d(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "loading persistent data: "
    ...
    const-string/jumbo v1, "Deleted persistence file"
    ...
    const-string/jumbo v1, "Cannot delete persistence file"
...
.method public static logEvent(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "String eventId passed to logEvent was null."
...
.method public static logEvent(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-string/jumbo v1, "String parameters passed to logEvent was null."
...
.method private static n()Lcom/flurry/android/IAppCloudModule;
    ...
    :cond_0
    :try_start_0
    const-string/jumbo v0, "com.flurry.android.es"
...
.method private static o()Lcom/flurry/android/IFlurryAds;
    ...
    :cond_0
    :try_start_0
    const-string/jumbo v0, "com.flurry.android.FlurryAds"
...
.method static q()Z
    ...
    :cond_2
    :try_start_0
    const-string/jumbo v2, "com.flurry.android.es"
    ...
    const-string/jumbo v3, "isAppCloudEnabled caught:"
...
.method static r()Z
    ...
    :cond_2
    :try_start_0
    const-string/jumbo v2, "com.flurry.android.FlurryAds"
    ...
    const-string/jumbo v3, "isAppSpotEnabled caught:"
...
.method private v()V
    ...
    const-string/jumbo v1, "generating agent report"
    ...
    const-string/jumbo v3, "generated report of size "
    ...
    const-string/jumbo v2, "Done sending "
    ...
    const-string/jumbo v2, "agent report"
    ...
    const-string/jumbo v1, "Error generating report"
...
.method private declared-synchronized w()V
    ...
    const-string/jumbo v1, "ERROR! CREATE PARENT DIR DIDN\'T PROCCEED"
...
.method protected final fetchHashedImei(Landroid/content/Context;)[B
    ...
    const-string/jumbo v3, "sha1 is not 20 bytes long: "
...
.method public final onNetworkStateChanged(Z)V
    ...
    .prologue
    .line 1861
    const-string/jumbo v0, "myNetworkListener"
