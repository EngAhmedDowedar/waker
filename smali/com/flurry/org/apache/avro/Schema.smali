...
.method public static create(Lcom/flurry/org/apache/avro/Schema$Type;)Lcom/flurry/org/apache/avro/Schema;
    ...
    const-string/jumbo v2, "Can\'t create a: "
...
.method static parse(Lcom/flurry/org/codehaus/jackson/JsonNode;Lcom/flurry/org/apache/avro/Schema$Names;)Lcom/flurry/org/apache/avro/Schema;
    ...
    const-string/jumbo v38, "Undefined name: "
    ...
    const-string/jumbo v37, "No type"
    ...
    const-string/jumbo v37, "No name in schema"
    ...
    const-string/jumbo v38, "Record has no fields: "
    ...
    const-string/jumbo v37, "No field name"
    ...
    const-string/jumbo v38, "No field type: "
    ...
    const-string/jumbo v38, " is not a defined name."

    invoke-virtual/range {v37 .. v38}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v37

    const-string/jumbo v38, " The type of the \""
    ...
    const-string/jumbo v38, "\" field must be"

    invoke-virtual/range {v37 .. v38}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v37

    const-string/jumbo v38, " a defined name or a {\"type\": ...} expression."
    ...
    .line 1173
    const-string/jumbo v36, "symbols"
    ...
    const-string/jumbo v38, "Enum has no symbols: "
    ...
    const-string/jumbo v38, "Array has no items type: "
    ...
    const-string/jumbo v38, "Map has no values type: "
    ...
    const-string/jumbo v38, "Invalid or no size: "
    ...
    const-string/jumbo v38, "Type not supported: "
    ...
    const-string/jumbo v38, "Schema not yet supported: "
...
.method private static parseAliases(Lcom/flurry/org/codehaus/jackson/JsonNode;)Ljava/util/Set;
    ...
    const-string/jumbo v6, "aliases not an array: "
    ...
    const-string/jumbo v6, "alias not a string: "
...
.method private static validateName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "Empty name"
    ...
    const-string/jumbo v6, "Illegal initial character: "
...
.method public addAlias(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Not a named type: "
...
.method fieldsToJson(Lcom/flurry/org/apache/avro/Schema$Names;Lcom/flurry/org/codehaus/jackson/JsonGenerator;)V
    ...
    const-string/jumbo v2, "Not a record: "
...
.method public getFixedSize()I
    ...
    const-string/jumbo v2, "Not fixed: "
...
.method public getIndexNamed(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    const-string/jumbo v2, "Not a union: "
