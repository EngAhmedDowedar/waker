...
.method private checkFixed(I)V
    ...
    const-string/jumbo v3, "Incorrect length for fixed binary: expected "
    ...
    const-string/jumbo v3, " but received "
...
.method private doSkipFixed(I)V
    ...
    const-string/jumbo v3, "Expected fixed length "
...
.method private static getSymbol(Lcom/flurry/org/apache/avro/Schema;)Lcom/flurry/org/apache/avro/io/parsing/Symbol;
    ...
    const-string/jumbo v1, "Schema cannot be null!"
...
.method public configure(Ljava/io/InputStream;)Lcom/flurry/org/apache/avro/io/JsonDecoder;
    ...
    const-string/jumbo v1, "InputStream to read from cannot be null!"
...
.method public configure(Ljava/lang/String;)Lcom/flurry/org/apache/avro/io/JsonDecoder;
    ...
    const-string/jumbo v1, "String to read from cannot be null!"
...
.method public doAction(Lcom/flurry/org/apache/avro/io/parsing/Symbol;Lcom/flurry/org/apache/avro/io/parsing/Symbol;)Lcom/flurry/org/apache/avro/io/parsing/Symbol;
    ...
    const-string/jumbo v6, "Expected field name not found: "
    ...
    .line 490
    :cond_6
    const-string/jumbo v4, "record-start"
    ...
    const-string/jumbo v5, "Unknown fields: "
    ...
    const-string/jumbo v4, "record-end"
    ...
    :cond_b
    const-string/jumbo v4, "union-end"
    ...
    const-string/jumbo v6, "Unknown action symbol "
...
.method public readEnum()I
    ...
    const-string/jumbo v4, "Unknown symbol in enum "
...
.method public readIndex()I
    ...
    const-string/jumbo v5, "Unknown union branch "
    ...
    .end local v1    # "label":Ljava/lang/String;
    :cond_1
    const-string/jumbo v3, "start-union"
...
.method public readMapStart()J
    ...
    .line 394
    :cond_0
    const-string/jumbo v0, "map-start"
